...
public class JavaLatentDirichletAllocationExample {
    public static void main(String[] args) {
        ...
        JavaSparkContext jsc = new JavaSparkContext("local", "JavaKLatentDirichletAllocationExample", conf);

        // $example on$
        // Load and parse the data
        String path = "src/main/java/com/daslab/czy/sample_lda_data.txt";
